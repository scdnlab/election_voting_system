<?php /* Smarty version 2.6.6, created on 2010-10-03 19:29:24
...
<form action="index.php" method="post" name="loginForm" id="loginForm" style="clear: both;">
    <p>
        ...
        <input name="login[username]" value="" id="username" type="text" class="inputbox" size="15" value="<?php echo $_REQUEST['login']['username']; ?>
"/>
    </p>
